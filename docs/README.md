...
| # | 문서 | 내용 |
|---|---|---|
| 01 | [데이터베이스 설계서](01-DATABASE-MODEL.md) | 테이블 12종, 참조 무결성, 제약, 상태 전이, 마이그레이션, 보존 정책 |
| 02 | [API 명세서](02-API-SPEC.md) | 엔드포인트 56종의 요청·응답 전수, 표준 봉투, 오류 코드 카탈로그 |
...
| 06 | [UX 설계서](06-USER-EXPERIENCE.md) | 화면 20종의 레이아웃·상호작용·상태, 여정, 마이크로카피 전량 |
| 07 | [교차 검토 기록](07-CROSS-REVIEW.md) | 문서 간 불일치 27건의 식별과 조치 |
| 08 | [소셜 로그인 설계서](08-SOCIAL-AUTH.md) | OAuth 2.0 리다이렉트 흐름, PKCE·state 방어, 계정 연결 정책, 리다이렉트 URI |
